...
def train_arg_parser():
    ...
    parser.add_argument('--exp_id', type=str, default='unet')
...
def test_arg_parser():
    ...
    parser.add_argument('--model_path', type=str, default='results/train/unet/model/unet_13.pt')
    
    # Experiment ID to use latest saved model 
    parser.add_argument('--exp_id', type=str, default='plots')
